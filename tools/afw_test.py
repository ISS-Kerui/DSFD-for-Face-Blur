...
parser = argparse.ArgumentParser(description='dsfd evaluatuon afw')
...
AFW_RESULT_DIR = os.path.join(cfg.FACE.AFW_DIR, 'dsfd')
...
if __name__ == '__main__':
    ...
    counter = 0
    txt_out = os.path.join(AFW_RESULT_DIR, 'dsfd_dets.txt')
